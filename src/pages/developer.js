                        ...
                        <div className="flex flex-col justify-between h-96 px-4 w-80 md:px-0">
                            ...
                            <div className="grid grid-cols-2 gap-4 dark:text-gray-300">
                                <div
                                    ...
                                    <a className="cursor-pointer" href="https://github.com/SatvikVirmani"><FontAwesomeIcon icon={faGithub}/>
                                        Github</a>
                                </div>
                                <div
                                    className="dark:hover:text-purple-500 hover:text-purple-500 text-center font-semibold">
                                    <a className="cursor-pointer" href="https://satvikvirmani.medium.com/"><FontAwesomeIcon icon={faMedium}/>
                                        Medium</a>
                                </div>
                                <div
                                    className="dark:hover:text-purple-500 hover:text-purple-500 text-center font-semibold">
                                    <a className="cursor-pointer" href="https://www.instagram.com/satvikvirmani/"><FontAwesomeIcon icon={faInstagram}/>
                                        Instagram</a>
                                </div>
                                <div
                                    className="dark:hover:text-purple-500 hover:text-purple-500 text-center font-semibold">
                                    <a className="cursor-pointer" href="https://www.facebook.com/satvik.virmani.9/"><FontAwesomeIcon icon={faFacebook}/>
                                        Facebook</a>
                                </div>
                            </div>
